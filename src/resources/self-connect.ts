...
| FederatedAttestations | Celo Alfajores Testnet | \`0x70F9314aF173c246669cFb0EEe79F9Cfd9C34ee3\` |
| ODIS Payments | Celo Alfajores Testnet | \`0x645170cdB6B5c1bc80847bb728dBa56C50a20a49\` |
| Stable Token (cUSD) | Celo Alfajores Testnet | \`0x874069Fa1Eb16D44d622F2e0Ca25eeA172369bC1\` |

**Note:** Self Connect contracts are on Celo Alfajores testnet, which is separate from Self Pass's Celo Sepolia testnet.
...
export function registerSelfConnect(
  server: McpServer,
  config: ServerConfig
): void {
