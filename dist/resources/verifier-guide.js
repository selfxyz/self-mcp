...
\`\`\`
`;
export function registerVerifierGuide(server, config) {
    server.resource("verifier-guide", "self://contracts/verifier-guide", async (uri) => ({
        contents: [
            {
                uri: uri.href,
                mimeType: "text/plain",
...
//# sourceMappingURL=verifier-guide.js.map